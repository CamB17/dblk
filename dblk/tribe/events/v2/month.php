...
>
	<div class="tribe-common-l-container tribe-events-l-container">
		...
		<header <?php tribe_classes( $header_classes ); ?>>
			...
			<div class="clear-event-filters">
				<button class="clear-event-filters__button" onClick="window.location.reload();">Clear</button>
			</div>
		...
		<?php get_template_part('tribe/dblk_event_list/list'); ?>
