<?
class dblk_menu_walker extends Walker_Nav_Menu {
...
/**
 * dblk_nav_walker returns an instance of the walker_texas_ranger class with the following arguments
 ...
 * @return [type]
 */
function dblk_menu($location = "menu__main", $css_class_prefix = 'main-menu', $css_class_modifiers = null, $the_depth, $remove_plugin = false){
    ...
    $args = array(
        ...
        'walker'            => new dblk_menu_walker($css_class_prefix, true),
        'depth'             => $the_depth
    );
